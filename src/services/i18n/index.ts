...
export default class i18nService {
  ...
  constructor(configs: i18nConfigs, env?: string) {
    ...
    i18n.configure({
      ...
      autoReload: process.env.NODE_ENV !== "test", // Watch for changes in json files to reload locale on updates - defaults to false, but in test mode we make it false because it will prevent app exiting
    });
  }
